...
const BucketList = () => {
    ...
    // const apiKey = 'API_KEY = AIzaSyCA6Egp1CPDSAtuDEF1HxIxtvLNkaSfrqI';
    const { user_id } = user;
    console.log(user_id)
    ...
    //the object we get back from this axios call is the bucket_activities table, a user_id and a place_id
    useEffect(() => {
        if (user_id) {
