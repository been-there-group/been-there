    ...
    return(
        <section className='itinerary'>
            <div className='itineraryWords'>
                ...
                <p className='itineraryText'> Plan your trip one day at a time using our <div className='myTripAd'>&#8827;My Trip&#8826;</div> feature. Assign activities to each day of your trip to keep your vacation organized so you can focus on having fun.</p>
            </div>
