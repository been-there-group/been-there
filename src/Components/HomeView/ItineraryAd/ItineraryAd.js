    ...
    return(
        <section className='itinerary'>
            <div className='itineraryWords'>
                ...
                <div className='itineraryText'> Plan your trip one day at a time using our <p className='myTripAd'>&#8827;My Trip&#8826;</p> feature. Assign activities to each day of your trip to keep your vacation organized so you can focus on having fun.</div>
            </div>
