    ...
    return(
        <section className='itinerary'>
            <div className='itineraryWords'>
                ...
                <div className='itineraryText'> Plan your trip one day at a time using our &#187;My Trip&#171; feature. Assign activities to each day of your trip to keep your vacation organized so you can focus on having fun.</div>
            </div>
